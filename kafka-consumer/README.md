...
```bash
export MP_MESSAGING_INCOMING_CONSUMED_BOOTSTRAP_SERVERS=my-cluster-kafka-bootstrap-myproject.127.0.0.1.nip.io:443
```
...
export MP_MESSAGING_INCOMING_CONSUMED_SASL_MECHANISM=
export MP_MESSAGING_INCOMING_CONSUMED_SASL_JAAS_CONFIG=
```
